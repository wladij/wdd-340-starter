...
( 
	...
	lassification_id integer NOT NULL, 
...
-- Update the description of 'GM Hummer' to replace "small interiors" with "a huge interior"
UPDATE inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

-- Update all records in the inventory table to add '/vehicles' to the middle of the path in inv_image and inv_thumbnail
UPDATE inventory
